...
public class Name {
    ...
    public Name() {
        ...
        Name[30] = "ji|积极济技击疾及基集记纪季继吉计冀祭际籍";
        ...
        Name[60] = "wu|吴物务武午五邬兀毋戊";
        Name[61] = "xi|西席锡洗夕兮熹喜习戏系熙惜";
        Name[62] = "xiao|潇萧笑晓肖霄骁校";
        Name[63] = "xiong|熊雄";
        Name[64] = "yang|羊洋阳漾央秧炀飏鸯";
        Name[65] = "yi|易意依亦伊夷倚毅义宜仪艺译翼逸忆怡熠沂颐奕弈懿翊轶屹猗翌驿";
    ...
    public String getFamilyName() {
        ...
        int i = random.nextInt(86);
        String fName = sName[i].split("[|]")[0];
        return fName;
    }

    public String getName() {
        Random random = new Random();
        String mName = getNameKey();
